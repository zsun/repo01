...
class TC_ScreenShot < Test::Unit::TestCase
  ...
  def test_ScreenShotTrial
      get_login_page
      RMagicHelper.screenshot("_before_login")
      ...
      RMagicHelper.screenshot("_after_login")
...
C:\depot\tools\ruby\steamtest\Misc>gem install win32screenshot
Successfully installed win32screenshot-0.0.2
Installing ri documentation for win32screenshot-0.0.2...
Installing RDoc documentation for win32screenshot-0.0.2...
